                ...
                <form  method="post" action="" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" name="date_of_joining" value="{{old('date_of_joining',$getRecord->date_of_joining)}}" required>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="quallification" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea name="note"  style="width: 100%; margin-top:5px;" placeholder="Write Here!">{{$getRecord->note}}</textarea>
