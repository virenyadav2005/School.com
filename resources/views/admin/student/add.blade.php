                  ...
                  <div class="box-body">
                    <div class="row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="caste">
                            ...
                            <option {{(old('caste') == 'Brahmin') ? 'selected' : '' }} value="Brahmin">Brahmin</option>
                            <option {{(old('caste') == 'Kshatriya') ? 'selected' : '' }} value="Kshatriya">Kshatriya</option>
                            <option {{(old('caste') == 'Vaishya') ? 'selected' : '' }} value="Vaishya">Vaishya</option>
                            <option {{(old('caste') == 'Shudra') ? 'selected' : '' }} value="Shudra">Shudra</option>
                        </select>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="phone" class="form-control" name="mobile_number" value="{{old('mobile_number')}}" placeholder="Mobile Number">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="blood_group">
                            ...
                            <option {{(old('blood_group') == 'B') ? 'selected' : '' }} value="A">B</option>
                            <option {{(old('blood_group') == 'AB') ? 'selected' : '' }} value="A">AB</option>
                            <option {{(old('blood_group') == 'O+') ? 'selected' : '' }} value="A">O+</option>
                        </select>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <option value="">Select Status</option>
                            <option {{(old('status') == 100) ? 'selected' : '' }} value="0">Active</option>
